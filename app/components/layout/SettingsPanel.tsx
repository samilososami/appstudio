      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 md:inset-8 lg:inset-16 z-[70] bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col"
          >
            {/* Header */}
              ...
              <div className="max-w-2xl mx-auto space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    />
                    <span className="font-medium text-gray-900">Otro modelo...</span>
                  </button>
                  ...
                  {isCustomModel && (
                    ...
                    >
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border-2 border-bone-200 bg-white text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:border-water-500 focus:ring-4 focus:ring-water-100 transition-all"
                      />
                    </motion.div>
                  )}
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border-2 border-bone-200 bg-white text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:border-water-500 focus:ring-4 focus:ring-water-100 transition-all pr-24"
                    />
                    <button
